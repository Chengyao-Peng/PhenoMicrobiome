...
#     taxonomic_level = trial.suggest_categorical('taxonomic level', ['Pylum','Class','Order','Family','Genus', 'Species'])
    ...
    param = { 
            'n_estimators': trial.suggest_int('n_estimators', 50, 500, step=90),
...
if __name__ == "__main__":
	...
	#learn
	joblib.dump(study, os.path.join(DATA_DIRECTORY,'processed', 'Merged', 'X_genus_shared_filteredLow_relative_genus_train.csv', 'rf_batchCorrected.pkl'))
