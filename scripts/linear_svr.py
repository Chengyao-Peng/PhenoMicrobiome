...
if __name__ == "__main__":
	...
	#learn
	joblib.dump(study, os.path.join(DATA_DIRECTORY,'processed', 'Merged', 'X_genus_shared_filteredLow_relative_genus_train.csv', 'linear_svr_batchCorrected.pkl'))
